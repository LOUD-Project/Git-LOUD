...
function PositionWindow()
    ...
    if consControl:IsHidden() then
        LayoutHelpers.AtBottomIn(controls.bg, controls.parent)
        controls.abilities.Bottom:Set(function() return controls.bg.Bottom() - 24 end) -- -24
    else
        LayoutHelpers.AtBottomIn(controls.bg, controls.parent, 116) --120
        controls.abilities.Bottom:Set(function() return controls.bg.Bottom() - 23 end) -- -42
    end
    LayoutHelpers.AtLeftIn(controls.bg, controls.parent, 328) -- 17
end