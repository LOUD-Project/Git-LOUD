...
function SetLayout()
    ...
    if OrderGroup then
        LayoutHelpers.Above(control, OrderGroup, -132) -- 2
        LayoutHelpers.AtLeftIn(control, OrderGroup, 253)
    else
    ...
    if control.Description then
		...
		--this control description box ***
        control.Description.Width:Set(370) -- 400
        control.Description.Height:Set(45) -- 20
