...
local DefaultBuffAffect = AdjBuffFuncs.DefaultBuffAffect
local DefaultBuffRemove = AdjBuffFuncs.DefaultBuffRemove
...
BuffBlueprint { Name = 'T1PowerEnergyWeaponBonusSize8',
    ...
    Stacks = 'ALWAYS',
    Duration = -1,
    ParsedEntityCategory = categories.STRUCTURE * categories.SIZE8,
    BuffCheckFunction = AdjBuffFuncs.EnergyWeaponBuffCheck,
    OnBuffAffect = DefaultBuffAffect,
    OnBuffRemove = DefaultBuffRemove,
    Affects = {
...
BuffBlueprint { Name = 'T1MEXMassBuildBonus',
    ...
    Stacks = 'ALWAYS',
    Duration = -1,
    ParsedEntityCategory = categories.STRUCTURE - categories.ENGINEERSTATION,
    BuffCheckFunction = AdjBuffFuncs.BuildBuffCheck,
    OnBuffAffect = DefaultBuffAffect,
    OnBuffRemove = DefaultBuffRemove,
    Affects = {
