...
BuffBlueprint { Name = 'T1PowerEnergyWeaponBonusSize12',
    ...
    Stacks = 'ALWAYS',
    Duration = -1,
    ParsedEntityCategory = categories.STRUCTURE * categories.SIZE12 * categories.DEFENSE - categories.NUKE,
    BuffCheckFunction = AdjBuffFuncs.EnergyWeaponBuffCheck,
    OnBuffAffect = AdjBuffFuncs.EnergyWeaponBuffAffect,
    OnBuffRemove = AdjBuffFuncs.EnergyWeaponBuffRemove,
    Affects = {
...
BuffBlueprint { Name = 'T1PowerEnergyWeaponBonusSize16',
    ...
    Stacks = 'ALWAYS',
    Duration = -1,
    ParsedEntityCategory = categories.STRUCTURE * categories.SIZE16 * categories.DEFENSE - categories.NUKE,
    BuffCheckFunction = AdjBuffFuncs.EnergyWeaponBuffCheck,
    OnBuffAffect = AdjBuffFuncs.EnergyWeaponBuffAffect,
    OnBuffRemove = AdjBuffFuncs.EnergyWeaponBuffRemove,
    Affects = {
...
BuffBlueprint { Name = 'T1PowerEnergyWeaponBonusSize20',
    ...
    Stacks = 'ALWAYS',
    Duration = -1,
    ParsedEntityCategory = categories.STRUCTURE * categories.SIZE20 * categories.DEFENSE - categories.NUKE,
    BuffCheckFunction = AdjBuffFuncs.EnergyWeaponBuffCheck,
    OnBuffAffect = AdjBuffFuncs.EnergyWeaponBuffAffect,
    OnBuffRemove = AdjBuffFuncs.EnergyWeaponBuffRemove,
    Affects = {
...
BuffBlueprint { Name = 'T2PowerEnergyWeaponBonusSize4to12',
    ...
    Stacks = 'ALWAYS',
    Duration = -1,
    ParsedEntityCategory = (categories.STRUCTURE * (categories.SIZE4 + categories.SIZE8 + categories.SIZE12)) * categories.DEFENSE - categories.NUKE,
    BuffCheckFunction = AdjBuffFuncs.EnergyWeaponBuffCheck,
    OnBuffAffect = AdjBuffFuncs.EnergyWeaponBuffAffect,
    OnBuffRemove = AdjBuffFuncs.EnergyWeaponBuffRemove,
    Affects = {
...
BuffBlueprint { Name = 'T2PowerRateOfFireBonusSize4',
    ...
    Stacks = 'ALWAYS',
    Duration = -1,
    ParsedEntityCategory = categories.STRUCTURE * categories.SIZE4 * categories.DEFENSE - categories.NUKE,
    BuffCheckFunction = AdjBuffFuncs.RateOfFireBuffCheck,
    OnBuffAffect = AdjBuffFuncs.RateOfFireBuffAffect,
    OnBuffRemove = AdjBuffFuncs.RateOfFireBuffRemove,
    Affects = {
