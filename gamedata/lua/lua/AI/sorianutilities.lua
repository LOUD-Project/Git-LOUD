...
function Nuke(aiBrain)
    ...
    local atkPri = { 'STRUCTURE EXPERIMENTAL', 'EXPERIMENTAL ARTILLERY', 'STRUCTURE ARTILLERY TECH3', 'STRUCTURE NUKE TECH3', 'COMMAND', 'TECH3 MASSFABRICATION STRUCTURE', 'TECH3 ENERGYPRODUCTION STRUCTURE', 'TECH2 STRATEGIC STRUCTURE', 'TECH3 DEFENSE STRUCTURE', 'TECH2 DEFENSE STRUCTURE', 'TECH2 ENERGYPRODUCTION STRUCTURE' }
	local maxFire = false
