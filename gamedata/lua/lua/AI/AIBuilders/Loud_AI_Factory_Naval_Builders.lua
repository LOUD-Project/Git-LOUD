...
BuilderGroup { BuilderGroupName = 'Factory Production - Naval',
    ...
    Builder {BuilderName = 'Shield Boat - UEF',
        ...
        BuilderConditions = {
			...
			{ UCBC, 'PoolLessAtLocation', { 'LocationType', 6, categories.xes0205 * categories.NAVAL }},
...
BuilderGroup { BuilderGroupName = 'Factory Production - Naval - Small',
    ...
    Builder {BuilderName = 'T2 Sub - UEF - Small',	-- UEF Torpedo Boat
        ...
        BuilderConditions = {
			...
			{ UCBC, 'PoolLessAtLocation', { 'LocationType', 12, (categories.SUBMARINE + categories.xes0102) } },
    ...
    Builder {BuilderName = 'Counter Intel Boat - Cybran - Small',
        ...
        BuilderConditions = {
			...
			{ UCBC, 'PoolLessAtLocation', { 'LocationType', 2, categories.xrs0205 * categories.NAVAL }},			
