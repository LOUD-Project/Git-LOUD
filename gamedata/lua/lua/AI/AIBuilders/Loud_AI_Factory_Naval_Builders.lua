...
BuilderGroup { BuilderGroupName = 'Factory Production - Naval',
    ...
    Builder {BuilderName = 'T1 Frigate',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 80, categories.FRIGATE }},
    ...
    Builder {BuilderName = 'Destroyer',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 60, categories.DESTROYER }},
    ...
    Builder {BuilderName = 'Cruiser',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 60, categories.CRUISER }},
    ...
    Builder {BuilderName = 'T2 Sub - UEF',	-- UEF Torpedo Boat
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 75, categories.xes0102 }},
    ...
    Builder {BuilderName = 'T2 Sub - Aeon',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 75, categories.SUBMARINE }},
    ...
    Builder {BuilderName = 'Shield Boat - UEF',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 50, categories.xes0205 }},
