...
BuilderGroup { BuilderGroupName = 'Factory Production - Naval',
    ...
    Builder {BuilderName = 'T1 Frigate',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 100, categories.FRIGATE }},
    ...
    Builder {BuilderName = 'Destroyer',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 80, categories.DESTROYER }},
    ...
    Builder {BuilderName = 'Cruiser',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 80, categories.CRUISER }},
    ...
    Builder {BuilderName = 'T2 Sub - UEF',	-- UEF Torpedo Boat
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 100, categories.xes0102 }},
    ...
    Builder {BuilderName = 'T2 Sub - Aeon',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 100, categories.SUBMARINE }},
    ...
    Builder {BuilderName = 'Shield Boat - UEF',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 60, categories.xes0205 }},
    ...
    Builder {BuilderName = 'Counter Intel Boat - Cybran',
        ...
        BuilderConditions = {
            ...
            { LUTL, 'HaveLessThanUnitsWithCategory', { 45, categories.xrs0205 }},
