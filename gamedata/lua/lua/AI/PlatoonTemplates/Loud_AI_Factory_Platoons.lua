...
PlatoonTemplate { Name = 'T3BuildEngineerInitial',
    FactionSquads = {
        UEF = {
            { 'uel0309', 1, 4, 'Support', 'none' }
        },
        Aeon = {
            { 'ual0309', 1, 4, 'Support', 'none' }
        },
        Cybran = {
            { 'url0309', 1, 4, 'Support', 'none' }
        },
        Seraphim = {
            { 'xsl0309', 1, 4, 'Support', 'none' }
        },
    }
}
...
PlatoonTemplate { Name = 'T1Bomber',
    FactionSquads = {
        UEF = {
            { 'uea0103', 1, 2, 'Attack', 'none' },
        },
        Aeon = {
            { 'uaa0103', 1, 2, 'Attack', 'none' },
        },
        Cybran = {
            { 'ura0103', 1, 2, 'Attack', 'none' },
        },
        Seraphim = {
            { 'xsa0103', 1, 2, 'Attack', 'none' },
        },
    }
}
