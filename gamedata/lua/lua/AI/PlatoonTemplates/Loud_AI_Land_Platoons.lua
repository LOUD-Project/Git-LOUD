...
PlatoonTemplate { Name = 'ReinforceLandPlatoonDirect',
    GlobalSquads = {
        ...
        { (categories.LAND * categories.MOBILE * categories.ANTIAIR), 0, 10, 'Guard', 'none'},
...
PlatoonTemplate { Name = 'T2MassAttack',
    ...
    GlobalSquads = {
		...
		{ (categories.LAND * categories.MOBILE * categories.ANTIAIR), 6, 15, 'Guard', 'AttackFormation' },
...
PlatoonTemplate { Name = 'T3MassAttack',
    ...
    GlobalSquads = {
		...
		{ (categories.LAND * categories.MOBILE * categories.INDIRECTFIRE) - categories.EXPERIMENTAL, 11, 25, 'Artillery', 'none' },
...
PlatoonTemplate { Name = 'LandAttackLargeNW',
    ...
    GlobalSquads = {
		...
		{ (categories.LAND * categories.MOBILE * categories.INDIRECTFIRE) - categories.EXPERIMENTAL, 12, 30, 'Artillery', 'none' },
        { (categories.LAND * categories.MOBILE * categories.ANTIAIR), 12, 25, 'Guard', 'none' },
		{ (categories.LAND * categories.MOBILE * categories.SHIELD), 0, 10, 'Guard', 'none'},
		--{ (categories.LAND * categories.MOBILE * categories.ANTISHIELD), 0, 7, 'Attack', 'none'},
		{ (categories.LAND * categories.MOBILE * categories.COUNTERINTELLIGENCE), 0, 6, 'Guard', 'none'},
        { (categories.LAND * categories.MOBILE * categories.SCOUT), 0, 2, 'Support', 'none' },
...
PlatoonTemplate { Name = 'LandAttackHugeNW',
    Plan = 'LandForceAILOUD',
    GlobalSquads = {
        { (categories.LAND * categories.MOBILE * categories.DIRECTFIRE) - categories.SCOUT - categories.ENGINEER - categories.EXPERIMENTAL, 75, 125, 'Attack', 'none' },
		{ (categories.LAND * categories.MOBILE * categories.INDIRECTFIRE) - categories.EXPERIMENTAL, 12, 25, 'Artillery', 'none' },
        { (categories.LAND * categories.MOBILE * categories.ANTIAIR), 12, 25, 'Guard', 'none' },
...
PlatoonTemplate { Name = 'ReinforceAmphibiousPlatoon',
    GlobalSquads = {
        { (categories.LAND * categories.AMPHIBIOUS) * (categories.DIRECTFIRE + categories.INDIRECTFIRE) - categories.ENGINEER,  20, 40, 'Attack', 'none' },
        { (categories.LAND * categories.MOBILE * categories.ANTIAIR) * categories.AMPHIBIOUS, 0, 8, 'Support', 'none'},
		{ (categories.LAND * categories.MOBILE * categories.AMPHIBIOUS * categories.SHIELD), 0, 4, 'Guard', 'none' },
        { (categories.LAND * categories.MOBILE * categories.AMPHIBIOUS * categories.SCOUT), 0, 1, 'Support', 'none' },
	},
}
...
PlatoonTemplate { Name = 'AmphibAttackSmall',
    ...
    GlobalSquads = {
        { (categories.LAND * categories.AMPHIBIOUS) * (categories.DIRECTFIRE + categories.INDIRECTFIRE) - categories.SCOUT, 12, 20, 'Attack', 'none' },
		{ (categories.LAND * categories.AMPHIBIOUS * categories.SHIELD), 0, 3, 'Guard', 'none' },
...
PlatoonTemplate { Name = 'AmphibAttackMedium',
    Plan = 'AmphibForceAILOUD',
    GlobalSquads = {
        { (categories.LAND * categories.AMPHIBIOUS) * (categories.DIRECTFIRE + categories.INDIRECTFIRE) - categories.SCOUT, 35, 60, 'Attack', 'none' },
...
PlatoonTemplate { Name = 'AmphibAttackLarge',
    Plan = 'AmphibForceAILOUD',
    GlobalSquads = {
        { (categories.LAND * categories.AMPHIBIOUS) * (categories.DIRECTFIRE + categories.INDIRECTFIRE) - categories.SCOUT, 65, 100, 'Attack', 'none' },
		{ (categories.LAND * categories.AMPHIBIOUS * categories.ANTIAIR), 0, 16, 'Guard', 'none' },
		{ (categories.LAND * categories.AMPHIBIOUS * categories.SHIELD), 0, 10, 'Guard', 'none' },
		--{ (categories.LAND * categories.AMPHIBIOUS * categories.ANTISHIELD), 0, 8, 'Attack', 'none'},
		{ (categories.LAND * categories.AMPHIBIOUS * categories.SCOUT), 0,  2, 'Scout', 'none' },
		--{ (categories.LAND * categories.MOBILE * categories.EXPERIMENTAL) - categories.url0401, 0, 4, 'Attack', 'none' },
    },
}
...
PlatoonTemplate { Name = 'AmphibAttackHuge',
    Plan = 'AmphibForceAILOUD',
    GlobalSquads = {
        { (categories.LAND * categories.AMPHIBIOUS) * (categories.DIRECTFIRE + categories.INDIRECTFIRE) - categories.SCOUT, 80, 125, 'Attack', 'none' },
		{ (categories.LAND * categories.AMPHIBIOUS * categories.ANTIAIR), 0, 20, 'Guard', 'none' },
		{ (categories.LAND * categories.AMPHIBIOUS * categories.SHIELD), 0, 15, 'Guard', 'none' },
		--{ (categories.LAND * categories.AMPHIBIOUS * categories.ANTISHIELD), 0, 8, 'Attack', 'none'},
		{ (categories.LAND * categories.AMPHIBIOUS * categories.SCOUT), 0,  2, 'Scout', 'none' },
		--{ (categories.LAND * categories.MOBILE * categories.EXPERIMENTAL) - categories.url0401, 0, 4, 'Attack', 'none' },
    },
...
PlatoonTemplate { Name = 'BaseGuardAAPatrol',
    ...
    GlobalSquads = {
		{ (categories.LAND * categories.MOBILE * categories.ANTIAIR), 10, 16, 'Guard', 'GrowthFormation' },
		{ (categories.LAND * categories.MOBILE * categories.SHIELD), 0, 1, 'Guard', 'none' },
		{ (categories.LAND * categories.MOBILE * categories.COUNTERINTELLIGENCE), 0, 1, 'Guard', 'none' },
...
PlatoonTemplate { Name = 'T2PointGuard',
    ...
    GlobalSquads = {
		...
		{ (categories.LAND * categories.MOBILE * categories.ANTIAIR), 5, 8, 'Guard', 'AttackFormation' },
		{ (categories.LAND * categories.MOBILE * categories.SHIELD), 0, 3, 'Guard', 'none' },
        { (categories.LAND * categories.MOBILE * categories.SCOUT), 0, 1, 'Scout', 'none' },
		{ (categories.LAND * categories.MOBILE * categories.COUNTERINTELLIGENCE), 0, 2, 'Guard', 'none' },
    },
...
PlatoonTemplate { Name = 'T2PointGuardArtillery',
    Plan = 'GuardPoint',    
    GlobalSquads = {
		{ (categories.LAND * categories.MOBILE * categories.INDIRECTFIRE) - categories.EXPERIMENTAL, 12, 25, 'Artillery', 'AttackFormation' },
		{ (categories.LAND * categories.MOBILE * categories.ANTIAIR), 6, 12, 'Guard', 'AttackFormation' },
