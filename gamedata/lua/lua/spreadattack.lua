...
function Init()
	LOG("*AI DEBUG SpreadAttack initialized")
...
function MakeShadowCopyOrders(command)
	...
	local Order = {	CommandType = "", Position    = {},	Target      = nil,  }
...
function SpreadAttack()
	...
	for _,unit in ipairs(curSelection) do
		...
		SimCallback( { Func = "GiveOrders", Args = { unit_orders = unitorders, unit_id = unit:GetEntityId() }, }, false )
