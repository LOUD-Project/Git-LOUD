        ...
        if GUI.slots[index] then
            ...
            if clientInfo.connected then
                ...
                if clientInfo.ping < 200 then
                    GUI.slots[index].ping:SetColor('ff00ff00')
                elseif clientInfo.ping < 400 then
                    GUI.slots[index].ping:SetColor('ffffff00')
                else
                    GUI.slots[index].ping:SetColor('ffff0000')
                end
            
                if clientInfo.quiet > 2000 then
					LOG("*AI DEBUG detected quiet more than 2 seconds")
                ...
                GUI.slots[index].conn:SetColor('ff00ff00')
            ...
            if not clientInfo.connected or clientInfo.quiet > 2000 then
