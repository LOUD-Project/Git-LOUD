...
function GUIUIFile(filespec)
    ...
    local currentPath = '/lua/gaz_ui/textures/'..visitingSkin
    ...
    if visitingSkin == 'default' then
        ...
        while visitingSkin do
            ...
            if DiskGetFileInfo(curFile) then
                ...
                if visitingSkin then currentPath = '/lua/gaz_ui/textures/'..visitingSkin end
            end
        end
    end
...
function UIFile(filespec)
	...
	if DiskGetFileInfo(filespec) then
		return filespec
	end
...
-- button3Text: text for the third button (opt)
-- button3Callback: callback function for the third button, signature function() (opt)
