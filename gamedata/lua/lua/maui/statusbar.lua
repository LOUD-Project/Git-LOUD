...
StatusBar = Class(Bitmap)
{
        ...
        if self._vertical then
            if self._negative then
                ...
                self._bar.Bottom:Set(function() 
                    ...
                    return LOUDFLOOR(self.Top() + (rangePercent * (self.Bottom() - self.Top())))
                end)
            else
                ...
                self._bar.Top:Set(function()
                    ...
                    return LOUDFLOOR(self.Bottom() - (rangePercent * (self.Bottom() - self.Top())))
                end)
            end
    ...
    _CalcRangePercent = function(self)
        if self._minSlidePercent == 0 then
            ...
            return LOUDFLOOR(((self._value() - self._rangeMin) / (self._range)) / self._minSlidePercent) * self._minSlidePercent
        end
    end,
