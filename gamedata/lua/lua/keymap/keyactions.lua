...
keyActions = {
	...
	['select_groundattack'] =  {action =  'UI_SelectByCategory AIR BOMBER, GROUNDATTACK', category = 'selection', order = 41,},
	
	['select_transport'] =  {action =  'UI_SelectByCategory AIR TRANSPORTFOCUS', category = 'selection', order = 41,},
