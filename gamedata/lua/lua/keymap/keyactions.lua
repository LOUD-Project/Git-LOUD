...
keyActions = {
    ...
    ['decrease_game_speed_by_3'] = {action = 'UI_Lua import("/lua/ui/uimain.lua").ChangeSimRate(-3)',
        category = 'game', order = 7,},
    ['increase_game_speed'] = {action = 'UI_Lua import("/lua/ui/uimain.lua").IncreaseGameSpeed()',
        category = 'game', order = 2,},
    ['increase_game_speed_by_3'] = {action = 'UI_Lua import("/lua/ui/uimain.lua").ChangeSimRate(3)',
        category = 'game', order = 8,},
    ['reset_game_speed'] = {action = 'WLD_ResetSimRate',
        category = 'game', order = 3,},
    ['set_game_speed_minus_10'] = {action = 'WLD_GameSpeed -10',
        category = 'game', order = 5,},
    ['set_game_speed_plus_10'] = {action = 'WLD_GameSpeed +10',
        category = 'game', order = 6,},
    ['toggle_the_wind'] = {action = 'wld_RunWithTheWind',
        category = 'game', order = 9,},
