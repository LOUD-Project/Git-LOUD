...
function initalize()
    ...
    locals['ur_AMPHIBIOUS'] = 'No Amphibious'
    locals['ur_AMPHIBIOUS_info'] = 'Players will not be able to build Amphibious units (except engineers and SACUs).'
    locals['ur_HOVER']  = 'No Hover'
    locals['ur_HOVER_info'] = 'Players will not be able to build Hover units.'    
