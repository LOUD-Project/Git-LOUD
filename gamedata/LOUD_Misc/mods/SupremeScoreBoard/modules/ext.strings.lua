...
function initalize()
    ...
    locals['vc_demoralization_info'] = 'Player is defeated when the Commander is destroyed'	
	locals['vc_decapitation'] = 'Advanced Assassination'
    locals['vc_decapitation_info'] = 'Player is defeated when the Commander and all Support Commanders are destroyed'	
    locals['vc_domination'] = 'Supremacy'
    locals['vc_domination_info'] = 'Player is defeated when all engineers, factories and any unit that can build an engineer are destroyed'
    locals['vc_eradication'] = 'Annihilation'
    locals['vc_eradication_info'] = 'Player is defeated when all structures (except walls) and all units are destroyed'
    locals['vc_sandbox'] = 'Sandbox'
    locals['vc_sandbox_info'] = 'Player is never defeated'
    -- Unit Restrictions
    ...
    locals['ur_INTEL_info'] = 'No radar, sonar or omni installations'
    locals['ur_T3MOBILEAA'] = 'No TECH 3 Mobile Anti Air'
    locals['ur_SHIELDS'] = 'No Shields'
