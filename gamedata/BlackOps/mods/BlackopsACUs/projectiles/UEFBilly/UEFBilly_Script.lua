...
UEFBilly = Class(TIFMissileNuke) {
    ...
    OnImpact = function(self, TargetType, TargetEntity)
        if not TargetEntity or not EntityCategoryContains(categories.PROJECTILE, TargetEntity) then
			...
			nukeProjectile = self:CreateProjectile('/mods/Blackopsacus/effects/Entities/EXBillyEffectController01/EXBillyEffectController01_proj.bp', 0, 0, 0, nil, nil, nil):SetCollision(false)
