...
Description['bal0310'] = "The Wraith features a smaller direct fire version of the Sonance Artillery weapon and two side mounted weapons. As a potent hovercraft it makes an excellent unit either on land or water."
Description['bal0401'] = "The Inquisitor was designed specifically for the role of bombarding bases. Equipped with a downscaled version of the Artemis' Fire, it teleports its charges into the sky above its target. This process requires considerable power and leaves little room for defensive systems or secondary weapons."
Description['bal0403'] = "The Interrogator is the ultimate sniper. With radar, radar and sonar stealth, and a devastating long range implosion weapon, it makes an ideal infiltrator or siege unit."
Description['bab2308'] = "The Purifier fires a Tactical Missile that splits above the target area showering it with explosives."
Description['bab4307'] = "Long range, aquatic, Tactical Missile defense. Equipped with secondary anti-missile anti-torpedo local defense"
...
Description['bes0402'] = "The Conquest Class carries three X-Cannons which fires shells filled with concentrated anti-matter; it also carries 8 long ranged cannons and 8 flak guns. Capable of providing superb shore bombardment and adequate air defense."
Description['bea0402'] = "Unsatisfied with the performance of the original Citadel, the UEF redesigned it with a greater focus on air superiority. It lost much of its air-to-ground weaponry in favor of boosted air-to-air weapons for a greater focus upon air superiority."
...
Description['bel0211'] = "The Inferno uses a pair of flamethrowers to burn enemies to a crisp; heavily armored, but if its fuel tank is ruptured by weapons, it results in a violent explosion."
...
Description['beb1106'] = "Advanced storage building. Provides bonus for both Mass and Energy producing structures as well as storing Mass and Energy. Enhances energy weapon recharge rates."
...
Description['brl0205'] = "Ambush Assault unit. The Scorpion is equipped with a personal stealth field and becomes cloaked when standing still, allowing for ambushes against enemy forces."
Description['brl0307'] = "Medium Range Artillery Unit. The Hailfire fires a salvo of rockets at the target which detonate in a Low-Yield EMP Blast stunning enemy units."
...
Description['brb1106'] = "Advanced storage building. provides bonus for both Mass and Energy producing structures as well as storing Mass and Energy. Enhances energy weapon recharge rates."
Description['brlk001'] = "Advanced mobile anti-air unit. Utilizing a crude but effective target painter, the Bouncer can lead its missile salvo even to the fastest advanced aircraft. It can also use its missiles as anti-ground rockets without guidance."
...
Description['bsl0406'] = "Seth Ilhaas sends out signals which force enemy units to think it is a dangerous target. This makes the unit draw enemy fire while its allies fire back. Equipped with a restoration field and radar, making it an important part of any Seraphim assault group."
...
Description['bsb1106'] = "Advanced storage building. provides bonus for both Mass and Energy producing structures as well as storing Mass and Energy. Enhances energy weapon recharge rates."
