...
SIFHuAntiNuke01 = Class(SIFHuAntiNuke) {
     ...
     OnImpact = function(self, TargetType, TargetEntity) 
        ...
        for i = 0, (num_projectiles -1) do
            xVec = (LOUDSIN(angleInitial + (i*horizontal_angle) + RandomFloat(-angleVariation, angleVariation))) * RandomFloat(1,5)
            yVec =  RandomFloat(-3,33)
            zVec = (LOUDCOS(angleInitial + (i*horizontal_angle) + RandomFloat(-angleVariation, angleVariation))) * RandomFloat(1,5)
        ...
        horizontal_angle = (2*LOUDPI) / num_projectiles
        
        #############################################
        ######Create SMALL TENDRILS projectiles######
        for i = 0, (num_projectiles -1) do
            xVec = vx + (LOUDSIN(angleInitial + (i*horizontal_angle) + RandomFloat(-angleVariation, angleVariation))) * RandomFloat(1,5)
            yVec = RandomFloat(-3,33)
            zVec = vz + (LOUDCOS(angleInitial + (i*horizontal_angle) + RandomFloat(-angleVariation, angleVariation))) * RandomFloat(1,5)
