local CQuantumGateUnit = import('/lua/defaultunits.lua').FactoryUnit
...
URB0304 = Class(CQuantumGateUnit) {
    ...
    GateBones = {
        { 'Gate01_Left_FX','Gate01_Right_FX' },
        { 'Gate02_Left_FX','Gate02_Right_FX' },
        { 'Gate03_Left_FX','Gate03_Right_FX' },
    },
    
    GateEffects = {'/effects/emitters/cybran_gate_01_emit.bp','/effects/emitters/cybran_gate_02_emit.bp'},
