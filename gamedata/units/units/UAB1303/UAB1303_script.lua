...
--        self.Trash:Add(self.RingManip2)
        ...
        self.ParentManip1 = CreateRotator(self, 'B04', 'z', nil, 0, 15, 40 + Random(0, 20) * num)
        self.Trash:Add(self.ParentManip1)
        self.ParentManip2 = CreateRotator(self, 'B04', 'y', nil, 0, 15, 40 + Random(0, 20) * num)
        self.Trash:Add(self.ParentManip2)
        self.ParentManip3 = CreateRotator(self, 'B04', 'x', nil, 0, 15, 40 + Random(0, 20) * num)
...
--        self.RingManip2:SetSpinDown(true)
        ...
        self.ParentManip1:SetTargetSpeed(40 + Random(0, 20) * num)
        self.ParentManip2:SetSpinDown(true)
        self.ParentManip2:SetTargetSpeed(40 + Random(0, 20) * num)
        self.ParentManip3:SetSpinDown(true)
        self.ParentManip3:SetTargetSpeed(40 + Random(0, 20) * num)
    end,
