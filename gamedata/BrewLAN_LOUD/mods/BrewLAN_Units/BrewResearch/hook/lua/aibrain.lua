    ...
    OnCreateAI = function(self, planName)
        ...
        self.BrewRND = {
            ...
            GetResearchItem = function(self, center)
                ...
                LOG("*AI DEBUG "..self.Nickname.." starting research for " .. 
                    (__blueprints[choice].Description or "unknown research item") .. ".")
                return choice
            end,
                            ...
                            for id, cat in self.BrewRND.CategoryResearch do
                                if table.find(bp.Categories, cat) then
                                    if AddResearch(self, id) then
                                        -- If this works, nil the entry so we don't search for this cat research again.
                                        -- The request won't go away until it's completed.
