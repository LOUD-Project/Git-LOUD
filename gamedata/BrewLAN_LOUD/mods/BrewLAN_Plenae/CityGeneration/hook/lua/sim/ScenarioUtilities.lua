...
CityData = {
    {   --UEF
        ...
        BlockSpacing = {10,10},
        CityRadius = {3,5}, --generation will stop between these two numbers from centre
        Wall = 'seb5101',
        Turrets = {
            {'ueb2101', Weight = 1 },
            {'ueb2104', Weight = 1 },
...
function GetRandomCityFactionGenerator()
    if CityData[1] then
        ...
        return import('/lua/sim/scenarioutilities.lua')[CityData[no].FunctionName], CityData[no]
    end
end
