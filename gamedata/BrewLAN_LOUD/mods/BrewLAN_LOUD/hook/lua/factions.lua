do
    ...
    if not import(import( '/lua/game.lua' ).BrewLANLOUDPath() .. '/lua/legacy/VersionCheck.lua').VersionIsSC() then --If not original Steam SupCom
	
        --local BrewLANIconsDir = import( '/lua/game.lua' ).BrewLANLOUDPath() .. '/textures/ui/common/icons/units/'
