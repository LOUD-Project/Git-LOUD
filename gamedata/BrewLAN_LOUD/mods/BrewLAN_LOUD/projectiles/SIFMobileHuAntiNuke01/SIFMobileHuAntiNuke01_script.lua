...
SIFMobileHuAntiNuke01 = Class(SIFHuAntiNuke) {
    ...
    -- This is a custom impact to maeke the seraphim hit look really good, a tendrilled explosion
...
TypeClass = SIFMobileHuAntiNuke01
