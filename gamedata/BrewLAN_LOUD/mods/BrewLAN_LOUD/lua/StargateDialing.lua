...
function StargateDialing(SuperClass)
    return Class(SuperClass) {
        ...
        OnTargetLocation = function(self, location)
            ...
            and targetgate:GetCurrentLayer() == self:GetCurrentLayer() --Only allow connections between gates on the same layer
            then
        ...
        EventHorizonToggle = function(self, value)
            if value then 
                ...
                self.EventHorizon:SetMesh( import( '/lua/game.lua' ).BrewLANLOUDPath() .. '/units/ssb5401/SSB5401_EventHorizon_mesh')
