...
local DeathNukeWeapon = import(BrewLANLOUDPath .. '/lua/sim/defaultweapons.lua').DeathNukeWeapon
local EnergyStorageVariableDeathWeapon = import(BrewLANLOUDPath .. '/lua/weapons.lua').EnergyStorageVariableDeathWeapon
