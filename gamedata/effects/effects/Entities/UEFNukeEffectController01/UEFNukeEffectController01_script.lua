...
UEFNukeEffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        local orientation = RandomFloat(0,2*LOUDPI)
		
        CreateDecal(position, orientation, 'Crater01_albedo', '', 'Albedo', 50, 50, 1200, 360, army)
        CreateDecal(position, orientation, 'Crater01_normals', '', 'Normals', 50, 50, 1200, 360, army)       
        CreateDecal(position, orientation, 'nuke_scorch_003_albedo', '', 'Albedo', 60, 60, 1200, 360, army)    
