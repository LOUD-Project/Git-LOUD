...
SeraphimNukeEffectController01 = Class(NullShell) {
    ...
    EffectThread = function(self)
        ...
        CreateLightParticle(self, -1, army, 100, 10, 'glow_02', 'ramp_blue_22')
        WaitSeconds( 0.3 )
        CreateLightParticle(self, -1, army, 60, 36, 'glow_02', 'ramp_blue_16')
        ...
        WaitSeconds( 3.0 )
        CreateLightParticle(self, -1, army, 120, 6, 'glow_02', 'ramp_blue_16')
        WaitSeconds( 0.1 )       
        CreateLightParticle(self, -1, army, 45, 45, 'glow', 'ramp_blue_22')
        ...
        CreateDecal(position, orientation, 'Scorch_012_albedo', '', 'Albedo', 120, 120, 1200, 360, army)
        CreateDecal(position, orientation, 'Crater01_normals', '', 'Normals', 60, 60, 1200, 360, army)       
