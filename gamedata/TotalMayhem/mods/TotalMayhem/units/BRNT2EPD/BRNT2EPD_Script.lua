	        ...
	        PlayFxMuzzleSequence = function(self, muzzle)
		        local army = self.unit:GetArmy()
  	            ...
  	            for k, v in self.FxVentEffect2 do
                    CreateAttachedEmitter(self.unit, 'smoke01', army, v):ScaleEmitter(0.75)
                    CreateAttachedEmitter(self.unit, 'smoke02', army, v):ScaleEmitter(0.75)
                    CreateAttachedEmitter(self.unit, 'smoke03', army, v):ScaleEmitter(0.5)
                    CreateAttachedEmitter(self.unit, 'smoke04', army, v):ScaleEmitter(0.5)
                    CreateAttachedEmitter(self.unit, 'Turret_Muzzle', army, v):ScaleEmitter(0.75)
                end
	            for k, v in self.FxVentEffect3 do
                    CreateAttachedEmitter(self.unit, 'BRNT2EPD', army, v):ScaleEmitter(0.5)
                end
