	...
	-- AEON
	Description['wal0401'] = "A slightly bigger, slightly improved Galactic Collossus."
    ...
    Description['web0404-Shield'] = "Adds to T2 level dome shield to the unit."
    Description['web0404-Radar_T3'] = "Adds T3 level radar to the unit."
	...
	Description['wel0302'] = "Wrecker is a T3 level Mongoose - Dual Gatlers with low altitude AA capability, personal shield and good speed."
	Description['wel0304'] = "A very tough amphibious tank."
	Description['wel0305'] = "Pegasus - partner to IronFist - bringing AA and TMD to the heaviest units that can be created at a factory."
	Description['wel0309'] = "Mobile SAM. Fires short range AA missiles. Very effective versus gunships with heavier armor than Cougar."
    Description['wel0341'] = "The need for artillery in amphibious operations finds it's answer in the Walrus."
    Description['wel0401'] = "Wyvern is a combat refit of the original FatBoy.  Remove the factory - add artillery.  Designed to provide ranged support for Battlegroups."
	...
	-- CYBRAN
    Description['wra0401'] = "A field revision of the Ripper, focused on ground attack but less air defense."
	...
	Description['wrl0305'] = "A very quick sniper with radar stealth.  It's weapon is only partially effective against shields. Unlike other snipers, While capable of firing on the move, it is quite inaccurate."
	Description['wrl0309'] = "Mobile SAM with radar onboard. Effective against high-end enemy air units."
	Description['wrl1466'] = "Star Strider is then refinement of many key Cybran concepts, quick, hard hitting, regenerative."
	...
	Description['wsl0404'] = "Experimental Mobile Field Artillery with local close defense weapon and AA."
