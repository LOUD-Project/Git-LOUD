...
CArtillery01 = Class(CArtilleryProtonProjectile) {

	PolyTrails = {
			'/mods/BattlePack/effects/emitters/w_c_art02_p_01_polytrail_emit.bp',
			'/mods/BattlePack/effects/emitters/w_c_art02_p_02_polytrail_emit.bp',
			},
	FxTrails = { 
