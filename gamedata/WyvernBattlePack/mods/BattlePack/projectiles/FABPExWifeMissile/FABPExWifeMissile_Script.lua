...
FABPExWifeMissile = Class(CLOATacticalMissileProjectile) {

    OnImpact = function(self, TargetType, TargetEntity) 
        
        local FxFragEffect = EffectTemplate.TFragmentationSensorShellFrag 
	local ChildProjectileBP = '/mods/BattlePack/projectiles/FABPExWifeChildMissile/FABPExWifeChildMissile_proj.bp'              
