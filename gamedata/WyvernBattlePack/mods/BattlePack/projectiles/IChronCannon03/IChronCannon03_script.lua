...
IChronCannon03 = Class(import('/mods/BattlePack/lua/BattlePackDefaultProjectiles.lua').SC2SinglePolyTrailProjectile) {
    ...
    FxTrailScale = 0.6,
    FxPropHitScale = 0.8,
    FxShieldHitScale = 0.8,
    FxLandHitScale = 0.8,
    FxUnitHitScale = 0.8,
    FxWaterHitScale = 0.8,

}
TypeClass = IChronCannon03