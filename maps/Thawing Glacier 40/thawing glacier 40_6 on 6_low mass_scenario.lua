ScenarioInfo = {
  name = 'Thawing Glacier 40 - 6 on 6 - Low Mass',
  description = '<LOC Thawing Glacier 40_Description>A trip to a bigger frozen landscape!',
  type = 'skirmish',
  starts = true,
  map_version = 11,
  preview = '',
  ...
  save = '/maps/Thawing Glacier 40/Thawing Glacier 40_6 on 6_Low Mass_save.lua',
