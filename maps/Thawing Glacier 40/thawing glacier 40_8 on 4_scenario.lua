ScenarioInfo = {
  name = 'Thawing Glacier 40 - 8 on 4',
  description = '<LOC Thawing Glacier 40_Description>A trip to a bigger frozen landscape!  Optimized for 8 vs. 4 AI.',
  type = 'skirmish',
  starts = true,
  map_version = 3,
  preview = '',
  ...
  save = '/maps/Thawing Glacier 40/Thawing Glacier 40_8 on 4_save.lua',
