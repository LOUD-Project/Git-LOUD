...
ScenarioInfo = {
    ...
    save = '/maps/hills of havoc wet/hills of havoc wet AD2_save.lua',
    script = '/maps/hills of havoc wet/hills of havoc wet AD2_script.lua',
    norushradius = 65,
    Configurations = {
        ['standard'] = {
            teams = {
