...
ScenarioInfo = {
    ...
    save = '/maps/hills of havoc wet/hills of havoc wet AD3_save.lua',
    script = '/maps/hills of havoc wet/hills of havoc wet AD3_script.lua',
    norushradius = 65,
    Configurations = {
        ['standard'] = {
            teams = {
